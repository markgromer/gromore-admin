...
class WebDB:
    ...
    def init(self):
        ...
        new_brand_cols = [
            ...
            ("jobber_client_secret", "TEXT DEFAULT ''"),
            ("jobber_refresh_token", "TEXT DEFAULT ''"),
            ("jobber_token_expires_at", "TEXT DEFAULT ''"),
            ("jobber_account_label", "TEXT DEFAULT ''"),
            ("jobber_webhook_secret", "TEXT DEFAULT ''"),
            ...
            ("ai_provider_base_url", "TEXT DEFAULT ''"),
            ("ai_openrouter_api_key", "TEXT DEFAULT ''"),
            ("ai_gemini_api_key", "TEXT DEFAULT ''"),
            ("ai_xai_api_key", "TEXT DEFAULT ''"),
            ("ai_bfl_api_key", "TEXT DEFAULT ''"),
            ("ai_custom_api_key", "TEXT DEFAULT ''"),
            ("ai_image_provider", "TEXT DEFAULT 'openai'"),
            ("ai_image_generation_model", "TEXT DEFAULT ''"),
            ("seo_research_enabled", "INTEGER DEFAULT 0"),
            ("seo_research_provider", "TEXT DEFAULT 'openrouter'"),
            ("seo_research_model", "TEXT DEFAULT 'perplexity/sonar'"),
            ("seo_research_daily_limit", "INTEGER DEFAULT 5"),
            ("seo_research_cache_days", "INTEGER DEFAULT 14"),
            ("seo_research_max_results", "INTEGER DEFAULT 8"),
            ("seo_perplexity_api_key", "TEXT DEFAULT ''"),
            ("email_sender_name", "TEXT DEFAULT ''"),
            ("email_reply_to", "TEXT DEFAULT ''"),
            ...
            ("local_falcon_api_key", "TEXT DEFAULT ''"),
            ...
            ("review_suppression_list", "TEXT DEFAULT ''"),
            ("reputation_widget_settings", "TEXT DEFAULT '{}'"),
            ("review_default_group_keys", "TEXT DEFAULT '[]'"),
    ...
    def update_brand_text_field(self, brand_id, field, value):
        allowed = {
            ...
            "ai_openrouter_api_key", "ai_gemini_api_key", "ai_xai_api_key", "ai_bfl_api_key", "ai_custom_api_key",
            "ai_image_provider", "ai_image_generation_model", "ai_quality_tier",
            "seo_research_enabled", "seo_research_provider", "seo_research_model",
            "seo_research_daily_limit", "seo_research_cache_days", "seo_research_max_results",
            "seo_perplexity_api_key",
            ...
            "google_maps_api_key", "google_place_id", "local_falcon_api_key",
            "review_destination_url", "review_request_sms_template",
            "review_request_email_subject", "review_request_email_template",
            "review_suppression_list",
            "reputation_widget_settings",
            "review_default_group_keys", "review_automation_group_keys", "review_automation_channels",
