...
class ClientVAServicesTests(unittest.TestCase):
    ...
    def test_logged_in_client_can_view_va_desk_page(self):
        ...
        self.assertIn("150 Tokens", body)
        self.assertIn("400 Tokens", body)
        self.assertIn("1000 Tokens", body)
        self.assertIn("2500 Tokens", body)
        self.assertIn("$59", body)
        self.assertIn("$149", body)
        self.assertIn("$349", body)
